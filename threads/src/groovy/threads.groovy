// Note that a closure in groovy implements a runnable
...
Thread.start('thread-name') { /* do something */ }   // we need to name our threads so that they don't collide with each other
